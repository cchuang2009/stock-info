...
[data-testid="stSidebar"] { background: #0d1220 !important; border-right: 1px solid #1e293b; }
[data-testid="stSidebar"] * { color: #e2e8f0 !important; }
h1,h2,h3 { color: #38bdf8 !important; font-family: 'IBM Plex Mono', monospace !important; }
.stButton>button { background: #1e3a5f; color: #38bdf8; border: 1px solid #1e4a7f; border-radius: 4px; font-family: 'IBM Plex Mono', monospace; font-weight: 600; }
.stButton>button:hover { background: #1e4a8f; border-color: #38bdf8; }
...
.cal-table { width: 100%; border-collapse: collapse; font-family: 'IBM Plex Mono', monospace; }
.cal-table th { background: #0d1220; color: #475569; font-size: 12px; font-weight: 700;
    letter-spacing: .08em; text-align: center; padding: 10px 4px; border-bottom: 1px solid #1e293b; }
.cal-table td { vertical-align: top; padding: 6px 5px; border: 1px solid #1a2234;
    background: #0d1220; min-height: 80px; min-width: 120px; }
.cal-table td.today-cell { border: 2px solid #3b82f6 !important; background: #0f1f3d; }
.cal-table td.empty-cell { background: #090c16; }
.day-num { font-size: 12px; color: #475569; margin-bottom: 4px; }
.day-num.today { color: #3b82f6; font-weight: 700; }
.earn-chip { font-size: 11px; font-weight: 700; padding: 2px 7px; border-radius: 3px;
    margin-bottom: 3px; display: block; letter-spacing:.04em; }
.earn-pre  { background:#0e3a4a; color:#22d3ee; border:1px solid #22d3ee44; }
.earn-post { background:#4a2e06; color:#f59e0b; border:1px solid #f59e0b44; }
.earn-mid  { background:#2d1a4a; color:#a78bfa; border:1px solid #a78bfa44; }
.earn-unk  { background:#1e293b; color:#94a3b8; border:1px solid #33415544; }
.legend-item { display:inline-flex; align-items:center; gap:6px; margin-right:20px; font-size:12px; color:#94a3b8; }
.legend-dot { width:10px; height:10px; border-radius:2px; display:inline-block; }
.metric-card { background:#131929; border:1px solid #1e293b; border-radius:8px; padding:16px 20px; text-align:center; }
.metric-num { font-size:28px; font-weight:700; color:#38bdf8; }
.metric-label { font-size:11px; color:#475569; letter-spacing:.08em; text-transform:uppercase; margin-top:4px; }
[data-testid="stDataFrame"] { border: 1px solid #1e293b !important; border-radius: 8px; }
</style>
